...
public class ServiceUtil extends Service implements LocationListener {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.i("MainActivity", "ENTREI GOOGLE");
        ...
        client = new GoogleApiClient.Builder(this)
                ...
                .addConnectionCallbacks(new GoogleApiClient.ConnectionCallbacks() {
                    ...
                    public void onConnected(@Nullable Bundle bundle) {
                        Log.i("MainActivity", "CONECTEI GOOGLE");
    ...
    protected void createLocationRequest() {
        Log.i("MainActivity", "CRIA REQUEST");
        locationRequest = new LocationRequest();
        locationRequest.setInterval(UPDATE_INTERVAL_IN_MILLISECONDS);
        locationRequest.setFastestInterval(FASTEST_UPDATE_INTERVAL_IN_MILLISECONDS);
        locationRequest.setPriority(LocationRequest.PRIORITY_HIGH_ACCURACY);
        startLocationUpdates();
        Log.i("MainActivity", "SAI REQUEST");
    }
    ...
    protected void startLocationUpdates() {
        ...
        if ( Build.VERSION.SDK_INT >= 23 &&
            ...
            Log.i("MainActivity", "VERSAO INCOMPATIVEL");
            return  ;
        }
...
*/
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.i("MainActivity", "ENTREI 0");
        if(lastLocation!=null){
            if(location.distanceTo(lastLocation)>100){
                sendResult("0", null, null, null,null,null);//envia reset
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            Log.i("MainActivity", "SAI 1");
        }
        Log.i("MainActivity", "SAI 0");
    }

    private void getSnapshot() {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            sendResult("ask_permission", null, null,null,null,null);
        }
